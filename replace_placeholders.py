...
REPLACEMENTS = {
    "{NAME}": "The Forest",       # Nombre visible del juego
    "{ID}": "TheForestGame",         # ID usado en rutas/carpetas (sin espacios)
    "{REMOVE}": "TheForest",  # Nombre del ejecutable/proceso a cerrar
    "{GITHUB}": "TheForestGame",
    "{OLDREMOVE}": "TheForestGame",
    "{OLDDIR}": "TheForestGame",
}
