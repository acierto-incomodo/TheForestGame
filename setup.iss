[Setup]
AppName=The Forest by StormGamesStudios
AppVersion=1.0.5
DefaultDirName={userappdata}\StormGamesStudios\NewGameDir\TheForestGame
DefaultGroupName=StormGamesStudios
OutputDir=C:\Users\melio\Documents\GitHub\TheForestGame\output
OutputBaseFilename=TheForest_Launcher_Installer
Compression=lzma
...
[Files]
Source: "C:\Users\melio\Documents\GitHub\TheForestGame\dist\installer_updater.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\TheForestGame\theforest.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\TheForestGame\theforest.png"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{commonprograms}\StormGamesStudios\The Forest"; Filename: "{app}\installer_updater.exe"; IconFilename: "{app}\theforest.ico"; Comment: "Lanzador de The Forest"; WorkingDir: "{app}"
Name: "{commonprograms}\StormGamesStudios\Desinstalar The Forest"; Filename: "{uninstallexe}"; IconFilename: "{app}\theforest.ico"; Comment: "Desinstalar The Forest"

[Registry]
Root: HKCU; Subkey: "Software\The Forest"; ValueType: string; ValueName: "Install_Dir"; ValueData: "{app}"

[UninstallDelete]
Type: filesandordirs; Name: "{app}"

[Run]
Filename: "{app}\installer_updater.exe"; Description: "Ejecutar The Forest"; Flags: nowait postinstall skipifsilent
...
begin
  ...
  RunUninstaller(ExpandConstant('{userappdata}\StormGamesStudios\NewGameDir\TheForestGame'));
...
begin
  ...
  Exec('taskkill', '/F /IM "TheForest.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
  Exec('taskkill', '/F /IM "TheForest32.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
  Exec('taskkill', '/F /IM "TheForestVR.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
end;
