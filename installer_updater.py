...
URL_LAUNCHER = "https://github.com/acierto-incomodo/TheForestGame/releases/latest/download/launcher_win.exe"
URL_VERSION  = "https://github.com/acierto-incomodo/TheForestGame/releases/latest/download/version_win_launcher.txt"
