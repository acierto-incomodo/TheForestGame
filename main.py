...
BASE_URL_WIN = "https://github.com/acierto-incomodo/TheForestGame/releases/latest/download/Build.zip"
BUILD_URL_LINUX = "https://github.com/acierto-incomodo/TheForestGame/releases/latest/download/Build.zip"
VERSION_URL = "https://github.com/acierto-incomodo/TheForestGame/releases/latest/download/version.txt"
RELEASE_NOTES_URL = "https://github.com/acierto-incomodo/TheForestGame/releases/latest/download/ReleaseNotes.txt"
...
class LauncherWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("The Forest - Launcher")
    ...
    def setup_ui(self):
        ...
        title = QtWidgets.QLabel("The Forest")
